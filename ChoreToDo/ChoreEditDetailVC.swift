...
class ChoreEditDetailVC: UIViewController {
  ...
  override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
      ...
      note.date = dueDate
      note.isComplete = switchValue.isOn
...
extension ChoreEditDetailVC: UINavigationControllerDelegate, UIImagePickerControllerDelegate {
